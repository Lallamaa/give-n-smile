    ...
    <div class="container-fliud">
        ...
        <div class="container"> 
            <div class="pre-box box box-camp col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <a href="org_register.php" class="btn btn-primary">Register as Organization</a></input>
            </div>
            <div class="pre-box box box-fund col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                ...
                <a href="us_register.php" class="btn btn-primary">Register for Personal Account </a>
            </div>
        </div>
    </div>
