              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4><?php  echo  session_value("org_name");  ?></h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    <?php echo $_SESSION['organization']->org_name; ?>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="card h-100">
                    ...
                    <form method="POST" action="muser/us_editprofile.php">
                      <h6 class="d-flex align-items-center mb-3">
                        <i class="material-icons text-info mr-2">Organization Name</i><<?php  echo  $rows['org_name'];  ?></h6> 
                      <h6 class="d-flex align-items-center mb-3">
                        <i class="material-icons text-info mr-2">Organization Category</i><?php  echo  $rows['org_category'];  ?></h6>
                      <h6 class="d-flex align-items-center mb-3">
                        <i class="material-icons text-info mr-2">Password</i><?php  echo  $rows['org_password'];  ?></h6>
                      <h6 class="d-flex align-items-center mb-3">
                        <i class="material-icons text-info mr-2">Email</i><?php  echo  $rows['org_email'];  ?></h6>
                        <h6 class="d-flex align-items-center mb-3">
                      ...
                      <a href="org_editprofile.php"></br>Click to Update Profile</a>
                    </form>
                    </div>
                  </div>
                </div>                  
